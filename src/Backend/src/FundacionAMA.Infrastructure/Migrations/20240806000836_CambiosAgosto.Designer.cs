...
namespace FundacionAMA.Infrastructure.Migrations
{
    ...
    [Migration("20240806000836_CambiosAgosto")]
    partial class CambiosAgosto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 77, DateTimeKind.Local).AddTicks(9799),
                            CreatedBy = 0,
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.DonationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9678),
                            CreatedBy = 0,
                            Name = "viveres",
                            Status = "A"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9701),
                            CreatedBy = 0,
                            Name = "medicina",
                            Status = "A"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9703),
                            CreatedBy = 0,
                            Name = "vestimenta",
                            Status = "A"
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9706),
                            CreatedBy = 0,
                            Name = "monetario",
                            Status = "A"
                        },
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9708),
                            CreatedBy = 0,
                            Name = "tecnologia",
                            Status = "A"
                        },
                        new
                        {
                            Id = 6,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9710),
                            CreatedBy = 0,
                            Name = "suministros",
                            Status = "A"
                        },
                        new
                        {
                            Id = 7,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 91, DateTimeKind.Local).AddTicks(9712),
                            CreatedBy = 0,
                            Name = "varios",
                            Status = "A"
                        });
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.IdentificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Code = "CC",
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 97, DateTimeKind.Local).AddTicks(9614),
                            CreatedBy = 0,
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = false,
                            CreatedAt = new DateTime(2024, 8, 5, 19, 8, 25, 106, DateTimeKind.Local).AddTicks(2611),
                            CreatedBy = 0,
                            ...
                            Status = "A",
                            TempCode = "be70c7f2-0a04-45c4-830c-27f024bfccca"
                        });
                });
